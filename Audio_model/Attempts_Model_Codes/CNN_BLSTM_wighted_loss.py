...
DATA_DIR = DATA_DIR = r'C:\Users\ASUS\Downloads\BoAW_combined-20250427T130943Z-001\BoAW_combined' #access concatenated datasets
...
label_counts = Counter(label_df['Sleep_Disorder'])  # Only use the labels column
print(label_counts)
...
def train_and_evaluate():
    ...
    dataset = SleepDataset(DATA_DIR, label_map, 10000)
