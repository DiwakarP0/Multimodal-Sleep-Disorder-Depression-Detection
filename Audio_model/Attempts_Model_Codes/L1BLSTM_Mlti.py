...
NUM_EPOCHS = 40
LEARNING_RATE = 0.001
NUM_CLASSES = 4   # or >2 if multi-classification

DATA_DIR = "/data3/cgs616/ahmad/Audio_zip/Audio_model/BoAW_combined" #access concatenated datasets
LABEL_FILE = "/data3/cgs616/ahmad/Audio_zip/Audio_model/M_classified_labels.csv"
#  
